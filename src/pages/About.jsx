...
const officesData = [
  {
    ...
    title: "Baylounge",
    address: [
      "Baylounge, Baywalk Mall Pluit",
      "Pluit Karang Ayu Blok B.1 Utara RT 020/RW 002",
  ...
  },
  {
    ...
    address: [
      "Perumahan Pantai Mutiara Blok YJ No.16",
      "Pluit, Penjaringan, Jakarta Utara",
      "DKI Jakarta 14450",
    ],
  },
...
const salesManagers = [
  {
    role: "Admin",
    name: "Icha",
    phone: "+62 821 9726 3652",
    wa: "6282197263652",
  },
  {
    role: "Admin",
    name: "Michella",
    phone: "+62 822 3304 5894",
    wa: "6282233045894",
  },
];
...
function About() {
  ...
  return (
    <>
      ...
      <main className="nama-about-contact-page" id="top">
        <section className="nama-about-contact-hero">
          <p>[ BOAT & YACHT CHARTER ]</p>
          <h1>About Us</h1>
          <span>
            NAMA Marine assists private boat and yacht charter arrangements
            across Kepulauan Seribu, from vessel selection to route preparation.
          </span>
        </section>

        <nav className="nama-about-tabs" aria-label="About navigation">
          {aboutTabs.map((tab) => (
        ...
        <section className="nama-about-contact-section" id="offices">
          <div className="nama-about-section-label">
            <p>[ Offices ]</p>
          </div>

          <div className="nama-office-grid">
            {officesData.map((office) => (
              <article className="nama-office-card" key={office.title}>
                <p>[ {office.label} ]</p>
                <h2>{office.title}</h2>
        ...
        <section className="nama-about-contact-section" id="sales-manager">
          <div className="nama-about-section-label">
            <p>[ Sales Manager ]</p>
          </div>

          <div className="nama-sales-table">
        ...
        <section className="nama-about-company" id="company">
          <div>
            <p>[ Company ]</p>
          ...
          <p>
            We provide boat and yacht charter services for private journeys,
            group trips, island hopping, sunset cruise, and curated travel
            experiences across Kepulauan Seribu.
          </p>
        </section>
      </main>
